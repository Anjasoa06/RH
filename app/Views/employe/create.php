        ...
        <div class="form-section">
            ...
            <div class="f-group" style="margin-bottom:1rem">
                ...
                <select class="f-select" name="type_conge_id" required>
                    ...
                    <option value="1">Congé annuel (18 j restants)</option>
            ...
            <div style="padding:.75rem 1.1rem;display:flex;flex-direction:column;gap:.75rem">
                <div>
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px">
                        <span style="font-size:.8rem">Congé annuel</span>
                ...
                <div>
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px">
                        <span style="font-size:.8rem">Maladie</span>
                ...
                <div>
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px">
                        <span style="font-size:.8rem">Spécial</span>
