...
<head>
    ...
    <style>
        /* Copie ici le CSS de la page de login depuis le template */
        :root{
            ...
            --warn: #b8750a; --warn-bg: #fef9ee; --warn-br: #f5d98a;
            --success: #1e6b3f; --success-bg:#edf7f2; --success-br:#8fd4aa;
            --info: #1a4f7a; --info-bg: #eaf2fb; --info-br: #8fbde8;
        }
        *{box-sizing:border-box}
        ...
        .auth-page.geo-bg{position:relative;overflow:hidden}
        .auth-page.geo-bg::before{content:'';position:absolute;inset:0;background-image:repeating-linear-gradient(0deg,transparent,transparent 39px,rgba(255,255,255,.03) 40px),repeating-linear-gradient(90deg,transparent,transparent 39px,rgba(255,255,255,.03) 40px);pointer-events:none;z-index:0}
        ...
        <div class="auth-left">
            <div>
                ...
                <p class="auth-left-text" style="margin-top:2rem">
                    ...
                    Gérez vos demandes de congés, consultez votre solde et suivez l'état de vos demandes.
                </p>
            </div>
            <div class="auth-roles">
                ...
                <div class="role-pill">
                    ...
                    <div><div class="role-pill-name">Administrateur</div><div class="role-pill-cred">admin@rh.mg · admin123</div></div>
                </div>
                <div class="role-pill">
                    <i class="bi bi-person-check"></i>
                    <div><div class="role-pill-name">Responsable RH</div><div class="role-pill-cred">rh@rh.mg · rh123</div></div>
                </div>
                <div class="role-pill">
                    <i class="bi bi-person"></i>
                    <div><div class="role-pill-name">Employé</div><div class="role-pill-cred">jean@rh.mg · employe123</div></div>
                </div>
            </div>
        </div>
